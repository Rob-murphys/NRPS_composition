...
feature_path = "D:/OneDrive - University of Copenhagen/PhD/Projects/BGC_domain_amplicon_project/qiime_outputs/16S/redo/pre_filt_feature_tables/16S_profiles_redo_merged_table-dada2.qza"
...
physeq.removed = remove_unwanted(physeq) # 201 removed

# Removing singletons and those with less that 100 reads
physeq.removed.low = remove_low(physeq.removed) # removed 152607 taxa

# Identifying and removing contaminats based on prevalence method
physeq.noncontam = id_contam(physeq.removed.low = physeq.removed.low) # identified 165 contaminants
